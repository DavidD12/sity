...
impl<T: Copy + Display> Derived for Value<T> {
...
impl<T: Copy + Display> Derived for Metre<T> {
    fn symbol() -> &'static str {
        "m"
    }
}
pub type Metre2<T> = Quantity<T, Exp2, Exp0, Exp0, Exp0, Exp0>;
impl<T: Copy + Display> Derived for Metre2<T> {
    fn symbol() -> &'static str {
        "m²"
    }
}
pub type Metre3<T> = Quantity<T, Exp3, Exp0, Exp0, Exp0, Exp0>;
impl<T: Copy + Display> Derived for Metre3<T> {
    fn symbol() -> &'static str {
        "m³"
    }
}
...
impl<T: Copy + Display> Derived for KiloGram<T> {
    fn symbol() -> &'static str {
        "kg"
    }
}
...
impl<T: Copy + Display> Derived for Second<T> {
    fn symbol() -> &'static str {
        "s"
    }
}
...
impl<T: Copy + Display> Derived for Ampere<T> {
    fn symbol() -> &'static str {
        "A"
    }
}
...
impl<T: Copy + Display> Derived for Kelvin<T> {
    fn symbol() -> &'static str {
        "K"
    }
}
...
impl<T: Copy + Display> Derived for Newton<T> {
    fn symbol() -> &'static str {
        "N"
    }
}
...
impl<T: Copy + Display> Derived for Pascal<T> {
    fn symbol() -> &'static str {
        "Pa"
    }
}
...
impl<T: Copy + Display> Derived for Volt<T> {
    fn symbol() -> &'static str {
        "V"
    }
}
...
impl<T: Copy + Display> Derived for Joule<T> {
    fn symbol() -> &'static str {
        "J"
    }
}
...
impl<T: Copy + Display> Derived for Watt<T> {
    fn symbol() -> &'static str {
        "W"
    }
}
...
impl<T: Copy + Display> Derived for Hertz<T> {
    fn symbol() -> &'static str {
        "Hz"
    }
}
...
impl<T: Copy + Display> Derived for Coulomb<T> {
    fn symbol() -> &'static str {
        "C"
    }
}
...
impl<T: Copy + Display> Derived for Ohm<T> {
    fn symbol() -> &'static str {
        "Ω"
    }
}
...
impl<T: Copy + Display> Derived for Velocity<T> {
    fn symbol() -> &'static str {
        "m.s-1"
    }
}
...
impl<T: Copy + Display> Derived for Acceleration<T> {
    fn symbol() -> &'static str {
        "m.s-2"
    }
}
