...
impl<LE, ME, TE, IE, OE> Pow2 for Quantity<u32, LE, ME, TE, IE, OE>
where
    LE: Exponent + Pow2Exp,
    ME: Exponent + Pow2Exp,
    TE: Exponent + Pow2Exp,
    ...
    OE: Exponent + Pow2Exp,
{
    type Output = Quantity<u32, LE::Output, ME::Output, TE::Output, IE::Output, OE::Output>;
    fn pow2(self) -> Self::Output {
...
impl<LE, ME, TE, IE, OE> Pow3 for Quantity<u32, LE, ME, TE, IE, OE>
where
    LE: Exponent + Pow3Exp,
    ME: Exponent + Pow3Exp,
    TE: Exponent + Pow3Exp,
