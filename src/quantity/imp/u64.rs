...
impl<LE, ME, TE, IE, OE> Pow2 for Quantity<u64, LE, ME, TE, IE, OE>
where
    LE: Exponent + Pow2Exp,
    ME: Exponent + Pow2Exp,
    TE: Exponent + Pow2Exp,
    ...
    OE: Exponent + Pow2Exp,
{
    type Output = Quantity<u64, LE::Output, ME::Output, TE::Output, IE::Output, OE::Output>;
...
impl<LE, ME, TE, IE, OE> Pow3 for Quantity<u64, LE, ME, TE, IE, OE>
where
    LE: Exponent + Pow3Exp,
    ME: Exponent + Pow3Exp,
    TE: Exponent + Pow3Exp,
